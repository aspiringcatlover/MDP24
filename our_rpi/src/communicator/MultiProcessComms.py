                ...
                for message in message_list:
                    if len(message) <= 0:
                        ...
                        if message == AndroidToAlgorithm.START_EXPLORATION:
                            ...
                            self.message_queue.put_nowait(self._format_for(
                                ARDUINO_HEADER,
                                RPiToArduino.START_EXPLORATION
                            ))
                            ...
                            self.message_queue.put_nowait(self._format_for(
                                ARDUINO_HEADER,
                                RPiToArduino.START_FASTEST_PATH
                            ))
