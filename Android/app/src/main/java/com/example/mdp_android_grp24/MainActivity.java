package com.example.mdp_android_grp24;
...
import com.example.mdp_android_grp24.ui.main.BluetoothConnectionService;
import com.example.mdp_android_grp24.ui.main.BluetoothPopUp;
import com.example.mdp_android_grp24.ui.main.CommsFragment;
import com.example.mdp_android_grp24.ui.main.GridMap;
import com.example.mdp_android_grp24.ui.main.MapInformation;
import com.example.mdp_android_grp24.ui.main.MapTabFragment;
import com.example.mdp_android_grp24.ui.main.ReconfigureFragment;
import com.example.mdp_android_grp24.ui.main.SectionsPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < tabs.getTabCount(); i++) {
            int icon = 0;
            switch (i) {
                case 0: icon = R.drawable.ic_bluetooth_black_24dp; break;
                case 1: icon = R.drawable.ic_map; break;
                case 2: icon = R.drawable.ic_controller; break;
            }
        ...
        printMDFStringButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                refreshMessageReceived();
                message = GridMap.getImageString();
                editor.putString("message", CommsFragment.getMessageReceivedTextView().getText() + "\n" + message);
                editor.commit();
                refreshMessageReceived();
            }
