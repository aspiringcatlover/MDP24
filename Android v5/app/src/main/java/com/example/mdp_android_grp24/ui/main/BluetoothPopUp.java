...
public class BluetoothPopUp extends AppCompatActivity {
            ...
            try {
                if (BluetoothConnectionService.BluetoothConnectionStatus == false) {
                    ...
                    if (BluetoothConnectionService.BluetoothConnectionStatus) {
                        Toast.makeText(BluetoothPopUp.this, "Reconnection Success", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(BluetoothPopUp.this, "Failed to reconnect, retrying...", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        myDialog = new AlertDialog.Builder(BluetoothPopUp.this);
        myDialog.setTitle("Device Disconnected");
        myDialog.setMessage("Device has been disconnected. Do you want to reconnect?")
                .setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                        reconnectionHandler.post(reconnectionRunnable);
                    //    reconnectDialog = new ProgressDialog(BluetoothPopUp.this);
                    //    reconnectDialog.setMessage("Waiting for other device to reconnect...");
                    //    reconnectDialog.setCancelable(false);
                    //    reconnectDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "Cancel", new DialogInterface.OnClickListener() {
                     //       @Override
                     //       public void onClick(DialogInterface dialog, int which) {
                     //           retryConnection = false;
                     //           dialog.dismiss();
